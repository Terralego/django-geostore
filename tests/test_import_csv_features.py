...
class ImportCSVFeaturesTestCase(TestCase):
    ...
    def get_csv_reader_from_dict(self, fieldnames, rows):
        self.tmp_file = tempfile.NamedTemporaryFile(mode='r+', encoding='iso-8859-15', delete=False)
    ...
    def test_create_update(self):
        ...
        feature = self.layer.features.get(properties__SIREN='437582422', properties__NIC='00097')
