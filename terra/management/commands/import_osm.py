...
class Command(LayerCommandMixin, BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "query", action="store", help=_("Overpass query without type (out:json)")
        )
        parser.add_argument(
            "-t",
            "--type",
        ...
        parser.add_argument(
            ...
            action="store",
            help=_(
                "PK of the layer where to insert"
                "the features.\n"
        ...
        parser.add_argument(
            ...
            action="store",
            help=_(
                "Field in properties that will be used as "
