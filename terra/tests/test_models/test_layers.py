...
from terra.transformations import set_geometry_from_options
...
class LayerFromCSVDictReaderTestCase(TestCase):
    ...
    def get_csv_reader_from_dict(self, fieldnames, rows):
        self.tmp_file = tempfile.NamedTemporaryFile(
            mode="r+", encoding="iso-8859-15", delete=False
        )
    ...
    def test_missing_coordinates(self):
        ...
        self.layer.from_csv_dictreader(
            reader=reader, options=[], operations=[], pk_properties=["CODGEO"]
        )
    ...
    def test_init_options(self):
        ...
        for i in range(2):
            self.layer.features.create(
                geom=Point(), properties={"SIREN": "", "NIC": ""}
            )
        ...
        feature = self.layer.features.get(
            properties__SIREN="813792686", properties__NIC="00012"
        )
    ...
    def test_create_update(self):
        ...
        feature = self.layer.features.get(
            properties__SIREN="437582422", properties__NIC="00097"
        )
        self.assertEqual(
            feature.properties.get("L1_NORMALISEE", ""), "52 RUE JACQUES BABINET"
        )
    ...
    def test_operations(self):
        ...
        operations = [custom_transformation, set_geometry_from_options]
        self.layer.from_csv_dictreader(
            reader=reader,
            options=options,
            operations=operations,
...
class LayerSettingsTestCase(TestCase):
    ...
    def test_layer_settings(self):
        ...
        self.assertEqual(self.layer.layer_settings_with_default("tiles", "minzoom"), 0)
    ...
    def test_set_layer_settings(self):
        ...
        self.assertEqual(self.layer.layer_settings_with_default("foo", "bar"), 123)
